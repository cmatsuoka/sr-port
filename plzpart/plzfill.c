...
extern far void do_line(char far *to, int dx, int dy, int cnt, char far *from, long txx1, long txy1, long txx2, long txy2, int dseg);
extern far void do_block(int ycnt);
extern far void do_clear(char far *vmem, int far *otau, int far *ntau);
